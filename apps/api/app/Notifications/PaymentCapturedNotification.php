...
class PaymentCapturedNotification extends Notification implements ShouldBroadcastNow
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage())
            ...
            ->line($this->isHostRecipient
                ? 'Le paiement pour la réservation a été confirmé.'
    ...
    private function payload(): array
    {
        ...
        return [
            ...
            'body' => $this->isHostRecipient
                ? 'Paiement reçu pour ' . ($listing?->title ?? 'une réservation') . '.'
                : 'Votre paiement est confirmé pour ' . ($listing?->title ?? 'votre réservation') . '.',
